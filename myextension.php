 ...
 */
function myextension_civicrm_postInstall() {
  _myextension_civix_civicrm_postInstall();
}
 ...
 */
function myextension_civicrm_themes(&$themes) {
  _myextension_civix_civicrm_themes($themes);
}
 ...
 *
function myextension_civicrm_preProcess($formName, &$form) {
...
function myextension_civicrm_navigationMenu(&$menu) {
  _myextension_civix_insert_navigation_menu($menu, 'Mailings', array(
  ...
  _myextension_civix_navigationMenu($menu);
} // */
